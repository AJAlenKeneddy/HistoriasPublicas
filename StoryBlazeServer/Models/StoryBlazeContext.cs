...
public partial class StoryBlazeServerContext : DbContext
{
    public StoryBlazeServerContext()
    {
    }

    public StoryBlazeServerContext(DbContextOptions<StoryBlazeServerContext> options)
        : base(options)
    {
    }
